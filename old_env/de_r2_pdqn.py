...
@click.option('--reward-strategy', default="R2", help="Prefix of output files", type=str)
def run(seed, episodes, evaluation_episodes, batch_size, gamma, inverting_gradients, initial_memory_threshold,
        ...
        save_freq, save_dir, save_frames, visualise, action_input_layer, title, reward_strategy="R2"):
